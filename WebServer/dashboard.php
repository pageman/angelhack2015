                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  Choose a Wrapped Application
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-desktop fa-fw"></i> Applications</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-3">
                                        <a href="appview.php?appid=1">
                                            <img class="img-responsive" src="<?php echo $dbreturn[0]['urlimage']; ?>" alt="Android Ads">
                                        </a>
                                    </div>
                                    <div class="col-lg-3">
                                        <a href="appview.php?appid=2">
                                            <img class="img-responsive" src="<?php echo $dbreturn[1]['urlimage']; ?>" alt="Android Ads">
                                        </a>
                                    </div>
                                </div>
                            </div>
